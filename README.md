...
- Current supported question types: `single-choice`, `ordering`, `image-choice`, `matching`
...
- Date: 2026-04-19
- Summary: implemented scene registry, front-end scene panel, and phase-3 question engine progress with ordering, image-choice, and matching support
